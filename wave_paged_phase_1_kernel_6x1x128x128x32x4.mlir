...
module attributes {transform.with_named_sequence} {
  stream.executable private @phase_1 {
    stream.executable.export public @phase_1 workgroups(%arg0: index) -> (index, index, index) {
      ...
      stream.return %c1, %c6, %arg0 : index, index, index
    }
    builtin.module {
      func.func @phase_1(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding, %arg3: !stream.binding, %arg4: index) attributes {translation_info = #translation} {
        ...
        %block_id_y = gpu.block_id  y upper_bound 6
        ...
        %7 = stream.binding.subspan %arg0[%c0] : !stream.binding -> memref<8x?x6x128xf32, strided<[?, 768, 128, 1], offset: ?>>{%arg4}
        %8 = stream.binding.subspan %arg1[%c0] : !stream.binding -> memref<8x?x6xf32, strided<[?, 6, 1], offset: ?>>{%arg4}
        %9:3 = scf.for %arg5 = %c0 to %6 step %c1 iter_args(%arg6 = %cst, %arg7 = %cst_0, %arg8 = %cst_0) -> (vector<1xf32>, vector<1xf32>, vector<1xf32>) {
          %13 = vector.load %7[%arg5, %block_id_z, %block_id_y, %thread_id_x] : memref<8x?x6x128xf32, strided<[?, 768, 128, 1], offset: ?>>, vector<1xf32>
          %14 = vector.load %8[%arg5, %block_id_z, %block_id_y] : memref<8x?x6xf32, strided<[?, 6, 1], offset: ?>>, vector<1xf32>
        ...
        %11 = arith.truncf %10 : vector<1xf32> to vector<1xbf16>
        %12 = stream.binding.subspan %arg3[%c0] : !stream.binding -> memref<?x6x128xbf16, strided<[768, 128, 1], offset: ?>>{%arg4}
        vector.store %11, %12[%block_id_z, %block_id_y, %thread_id_x] : memref<?x6x128xbf16, strided<[768, 128, 1], offset: ?>>, vector<1xbf16>
        return
      }
    }
  }
  func.func @isolated_benchmark(%arg0: tensor<8x?x6x128xf32>, %arg1: tensor<8x?x6xf32>, %arg2: tensor<?xi32>, %arg3: tensor<?x6x128xbf16>, %arg4: index) -> tensor<?x6x128xbf16> {
    %0 = flow.dispatch @phase_1::@phase_1[%arg4](%arg0, %arg1, %arg2, %arg3, %arg4) : (tensor<8x?x6x128xf32>{%arg4}, tensor<8x?x6xf32>{%arg4}, tensor<?xi32>{%arg4}, tensor<?x6x128xbf16>{%arg4}, index) -> %arg3{%arg4}
    return %0 : tensor<?x6x128xbf16>
  }
}
